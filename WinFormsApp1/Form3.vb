...
Public Class Form3
    ...
    Private Sub DataFill()
        Dim cmd As New MySqlCommand("SELECT * FROM visitor", conn)
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        conn.Open()
        Dim cmd As New MySqlCommand("delete from visitor where lib_card = @id;", conn)
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        Dim editForm As New EditVisitor
        Dim ind = DataGridView1.SelectedRows(0).Index.ToString()
